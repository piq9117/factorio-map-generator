...
pub struct PathFinderSettings {
    ...
    pub goal_pressure_ratio: f32,
    pub use_path_cache: bool,
    pub max_steps_worked_per_tick: f32,
    pub max_work_done_per_tick: u32,
    pub short_cache_size: u32,
    pub long_cache_size: u32,
    pub short_cache_min_cacheable_distance: f32,
    pub short_cache_min_algo_steps_to_cache: u32,
    pub long_cache_min_cacheable_distance: f32,
    pub cache_max_connect_to_cache_steps_multiplier: u32,
    pub cache_accept_path_start_distance_ratio: f32,
    pub cache_accept_path_end_distance_ratio: f32,
    pub negative_cache_accept_path_start_distance_ratio: f32,
    pub negative_cache_accept_path_end_distance_ratio: f32,
    pub cache_path_start_distance_rating_multiplier: f32,
    pub cache_path_end_distance_rating_multiplier: f32,
    pub stale_enemy_with_same_destination_collision_penalty: f32,
    pub ignore_moving_enemy_collision_distance: f32,
    pub enemy_with_different_destination_collision_penalty: f32,
    pub general_entity_collision_penalty: f32,
    pub general_entity_subsequent_collision_penalty: f32,
    pub extended_collision_penalty: f32,
    ...
    pub short_request_ratio: f32,
    pub min_steps_to_check_path_find_termination: u32,
    pub start_to_goal_cost_multiplier_to_terminate_path_find: f32,
    pub overload_levels: Vec<u32>,
    pub overload_multipliers: Vec<f32>,
    pub negative_path_cache_delay_internal: u32,
}
